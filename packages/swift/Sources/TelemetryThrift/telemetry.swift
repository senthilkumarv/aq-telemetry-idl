...
public final class OverlaySkeleton {
...
public final class ChartSkeleton {
  ...
  public var overlays: TList<OverlaySkeleton>?
  ...
  public init(id: String, title: String, unit: String?, kind: ChartKind, yMin: Double?, yMax: Double?, fractionDigits: Int32?, series: TList<SeriesSkeleton>, overlays: TList<OverlaySkeleton>?) {
    self.id = id
    self.title = title
    self.unit = unit
    self.kind = kind
...
public final class OverlayUpdate {
...
public final class ChartUpdate {
  ...
  public var overlays: TList<OverlayUpdate>?
  ...
  public init(id: String, series: TList<SeriesUpdate>, overlays: TList<OverlayUpdate>?) {
    self.id = id
    self.series = series
    self.overlays = overlays
  }
