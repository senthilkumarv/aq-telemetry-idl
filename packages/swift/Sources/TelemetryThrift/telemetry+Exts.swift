...
public func ==(lhs: OverlaySkeleton, rhs: OverlaySkeleton) -> Bool {
  return
    (lhs.id == rhs.id) &&
    (lhs.name == rhs.name) &&
    (lhs.color == rhs.color)
...
extension OverlaySkeleton : CustomStringConvertible {

  public var description : String {
    var desc = "OverlaySkeleton("
    desc += "id=\(String(describing: self.id)), "
    desc += "name=\(String(describing: self.name)), "
    desc += "color=\(String(describing: self.color))"
    return desc
...
extension OverlaySkeleton : Hashable {
...
extension OverlaySkeleton : TStruct {

  public static var fieldIds: [String: Int32] {
    return ["id": 1, "name": 2, "color": 3, ]
  }

  public static var structName: String { return "OverlaySkeleton" }

  public static func read(from proto: TProtocol) throws -> OverlaySkeleton {
    _ = try proto.readStructBegin()
    var id: String!
    var name: String!
    var color: String?
    ...
    return OverlaySkeleton(id: id, name: name, color: color)
  }
...
extension ChartSkeleton : TStruct {
  ...
  public static var fieldIds: [String: Int32] {
    return ["id": 1, "title": 2, "unit": 3, "kind": 4, "yMin": 5, "yMax": 6, "fractionDigits": 7, "series": 8, "overlays": 9, ]
  }
  ...
  public static func read(from proto: TProtocol) throws -> ChartSkeleton {
    ...
    var overlays: TList<OverlaySkeleton>?
    ...
    fields: while true {
      ...
      switch (fieldID, fieldType) {
        ...
        case (9, .list):            overlays = try TList<OverlaySkeleton>.read(from: proto)
        case let (_, unknownType):  try proto.skip(type: unknownType)
      }
    ...
    return ChartSkeleton(id: id, title: title, unit: unit, kind: kind, yMin: yMin, yMax: yMax, fractionDigits: fractionDigits, series: series, overlays: overlays)
  }
...
public func ==(lhs: OverlayUpdate, rhs: OverlayUpdate) -> Bool {
  return
    (lhs.id == rhs.id) &&
    (lhs.points == rhs.points)
}

extension OverlayUpdate : CustomStringConvertible {

  public var description : String {
    var desc = "OverlayUpdate("
    desc += "id=\(String(describing: self.id)), "
    desc += "points=\(String(describing: self.points))"
    return desc
  }
...
extension OverlayUpdate : Hashable {
...
extension OverlayUpdate : TStruct {

  public static var fieldIds: [String: Int32] {
    return ["id": 1, "points": 2, ]
  }

  public static var structName: String { return "OverlayUpdate" }

  public static func read(from proto: TProtocol) throws -> OverlayUpdate {
    _ = try proto.readStructBegin()
    var id: String!
    var points: TList<SDPoint>!
    ...
    return OverlayUpdate(id: id, points: points)
  }
...
extension ChartUpdate : TStruct {
  ...
  public static var fieldIds: [String: Int32] {
    return ["id": 1, "series": 2, "overlays": 3, ]
  }
  ...
  public static func read(from proto: TProtocol) throws -> ChartUpdate {
    ...
    var overlays: TList<OverlayUpdate>?
    ...
    fields: while true {
      ...
      switch (fieldID, fieldType) {
        ...
        case (3, .list):            overlays = try TList<OverlayUpdate>.read(from: proto)
        case let (_, unknownType):  try proto.skip(type: unknownType)
      }
    ...
    return ChartUpdate(id: id, series: series, overlays: overlays)
  }
