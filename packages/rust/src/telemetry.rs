...
impl OverlaySkeleton {
  pub fn new<F1, F2, F3>(id: F1, name: F2, color: F3) -> OverlaySkeleton where F1: Into<Option<String>>, F2: Into<Option<String>>, F3: Into<Option<String>> {
    OverlaySkeleton {
      id: id.into(),
      name: name.into(),
      color: color.into(),
...
impl TSerializable for OverlaySkeleton {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<OverlaySkeleton> {
    i_prot.read_struct_begin()?;
    let mut f_1: Option<String> = Some("".to_owned());
    let mut f_2: Option<String> = Some("".to_owned());
    let mut f_3: Option<String> = None;
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("OverlaySkeleton");
    o_prot.write_struct_begin(&struct_ident)?;
    if let Some(ref fld_var) = self.id {
      o_prot.write_field_begin(&TFieldIdentifier::new("id", TType::String, 1))?;
      o_prot.write_string(fld_var)?;
...
pub struct ChartSkeleton {
  ...
  pub overlays: Option<Vec<OverlaySkeleton>>,
}

impl ChartSkeleton {
  pub fn new<F1, F2, F3, F4, F5, F6, F7, F8, F9>(id: F1, title: F2, unit: F3, kind: F4, y_min: F5, y_max: F6, fraction_digits: F7, series: F8, overlays: F9) -> ChartSkeleton where F1: Into<Option<String>>, F2: Into<Option<String>>, F3: Into<Option<String>>, F4: Into<Option<ChartKind>>, F5: Into<Option<OrderedFloat<f64>>>, F6: Into<Option<OrderedFloat<f64>>>, F7: Into<Option<i32>>, F8: Into<Option<Vec<SeriesSkeleton>>>, F9: Into<Option<Vec<OverlaySkeleton>>> {
    ChartSkeleton {
      id: id.into(),
      title: title.into(),
      unit: unit.into(),
...
impl TSerializable for ChartSkeleton {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<ChartSkeleton> {
    ...
    let mut f_9: Option<Vec<OverlaySkeleton>> = None;
    loop {
      let field_ident = i_prot.read_field_begin()?;
      if field_ident.field_type == TType::Stop {
        break;
      ...
      match field_id {
        ...
        9 => {
          let list_ident = i_prot.read_list_begin()?;
          let mut val: Vec<OverlaySkeleton> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_7 = OverlaySkeleton::read_from_in_protocol(i_prot)?;
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    if let Some(ref fld_var) = self.overlays {
      o_prot.write_field_begin(&TFieldIdentifier::new("overlays", TType::List, 9))?;
      o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, fld_var.len() as i32))?;
      for e in fld_var {
        e.write_to_out_protocol(o_prot)?;
      }
    ...
    loop {
      ...
      match field_id {
        ...
        2 => {
          ...
          for _ in 0..list_ident.size {
            let list_elem_8 = TileSkeleton::read_from_in_protocol(i_prot)?;
        ...
        3 => {
          ...
          for _ in 0..list_ident.size {
            let list_elem_9 = ChartSkeleton::read_from_in_protocol(i_prot)?;
    ...
    loop {
      ...
      match field_id {
        ...
        2 => {
          ...
          let mut val: Vec<SDPoint> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_10 = SDPoint::read_from_in_protocol(i_prot)?;
...
impl OverlayUpdate {
  pub fn new<F1, F2>(id: F1, points: F2) -> OverlayUpdate where F1: Into<Option<String>>, F2: Into<Option<Vec<SDPoint>>> {
    OverlayUpdate {
      id: id.into(),
      points: points.into(),
    }
...
impl TSerializable for OverlayUpdate {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<OverlayUpdate> {
    i_prot.read_struct_begin()?;
    let mut f_1: Option<String> = Some("".to_owned());
    let mut f_2: Option<Vec<SDPoint>> = Some(Vec::new());
    loop {
      ...
      match field_id {
        ...
        2 => {
          ...
          let mut val: Vec<SDPoint> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_11 = SDPoint::read_from_in_protocol(i_prot)?;
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("OverlayUpdate");
    o_prot.write_struct_begin(&struct_ident)?;
    if let Some(ref fld_var) = self.id {
      o_prot.write_field_begin(&TFieldIdentifier::new("id", TType::String, 1))?;
      o_prot.write_string(fld_var)?;
...
pub struct ChartUpdate {
  ...
  pub overlays: Option<Vec<OverlayUpdate>>,
}

impl ChartUpdate {
  pub fn new<F1, F2, F3>(id: F1, series: F2, overlays: F3) -> ChartUpdate where F1: Into<Option<String>>, F2: Into<Option<Vec<SeriesUpdate>>>, F3: Into<Option<Vec<OverlayUpdate>>> {
    ChartUpdate {
      id: id.into(),
      series: series.into(),
      overlays: overlays.into(),
...
impl TSerializable for ChartUpdate {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<ChartUpdate> {
    ...
    let mut f_3: Option<Vec<OverlayUpdate>> = None;
    loop {
      let field_ident = i_prot.read_field_begin()?;
      if field_ident.field_type == TType::Stop {
        break;
      ...
      match field_id {
        ...
        2 => {
          ...
          for _ in 0..list_ident.size {
            let list_elem_12 = SeriesUpdate::read_from_in_protocol(i_prot)?;
        ...
        3 => {
          let list_ident = i_prot.read_list_begin()?;
          let mut val: Vec<OverlayUpdate> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_13 = OverlayUpdate::read_from_in_protocol(i_prot)?;
  ...
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    if let Some(ref fld_var) = self.overlays {
      o_prot.write_field_begin(&TFieldIdentifier::new("overlays", TType::List, 3))?;
      o_prot.write_list_begin(&TListIdentifier::new(TType::Struct, fld_var.len() as i32))?;
      for e in fld_var {
        e.write_to_out_protocol(o_prot)?;
      }
    ...
    loop {
      ...
      match field_id {
        0 => {
          ...
          for _ in 0..list_ident.size {
            let list_elem_14 = SDAquarium::read_from_in_protocol(i_prot)?;
